...
class DynamicPillarVFE_3d(VFETemplate):
    ...
    def forward(self, batch_dict, **kwargs):
        ...
        batch_dict['point_coords'] = points_coords
        batch_dict['point_inverse_indices'] = unq_inv
        batch_dict['pillar_features'] = batch_dict['voxel_features'] = features
        batch_dict['voxel_coords'] = voxel_coords
        batch_dict['voxel_coords_flatten'] = unq_coords
        batch_dict['merge_coords'] = merge_coords
